...
public class SpringTrapAI : MonoBehaviour
{
   [Header("CẤU HÌNH PHẠM VI ĐA GIÁC (POLYGON)")]
    ...
    void UpdateAnimation()
    {
        ...
        // Nếu quái đang đứng chờ, đang chém, hoặc đã áp sát Player -> Đứng im (Idle)
        ...
        // Nếu không vướng các điều kiện đứng im ở trên, nghĩa là quái đang di chuyển (đi tuần hoặc rượt)
